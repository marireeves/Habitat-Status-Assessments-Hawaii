...
save.image("~/HSAs/HabitatStatusAssessmentsR/Hawaii/ShapeFiles4R/CoastalWetlandsStreamsOut/18_05_31_preintersectworkspacewetlands.RData")
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    
...
intersectqualni$newarea_m<-gArea(intersectqualni, byid = T)
intersectqualnidata<-intersectqualni@data
intersectqualni$keyinfo<-intersectqualni$WetlandType
write.csv(nwiqualdata, file = "nwiqualdata.csv")
toc()
